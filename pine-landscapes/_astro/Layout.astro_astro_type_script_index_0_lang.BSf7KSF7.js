const y="http://localhost:3000";function $(i,e,t){return Math.min(t,Math.max(e,i))}function R(i,e){let t;return(...o)=>{clearTimeout(t),t=setTimeout(()=>i(...o),e)}}function x(i,{timeoutMs:e=5e3,intervalMs:t=200}={}){const o=Date.now()+e;function n(){fetch(location.pathname+location.search,{cache:"no-store"}).then(a=>a.text()).then(a=>{i(a)||Date.now()>o?location.reload():setTimeout(n,t)}).catch(()=>location.reload())}n()}function A(i,{shouldExist:e,expectedSrc:t,timeoutMs:o=5e3,intervalMs:n=200}={}){const a=Date.now()+o;function s(l){const r=l.querySelector(`[data-image-slot="${CSS.escape(i)}"]`),g=r?r.querySelector("img"):null;return e?g?t?g.getAttribute("src").split("?")[0]===t.split("?")[0]:!0:!1:!g}function f(){function l(){fetch(location.pathname+location.search,{cache:"no-store"}).then(r=>r.text()).then(r=>{const g=new DOMParser().parseFromString(r,"text/html");s(g)||Date.now()>a?location.reload():setTimeout(l,n)}).catch(()=>location.reload())}l()}function d(){fetch(`${y}/api/image/${encodeURIComponent(i)}`,{cache:"no-store"}).then(async l=>{if(!e){if(l.status===404){f();return}if(Date.now()>a){location.reload();return}setTimeout(d,n);return}if(!l.ok){if(Date.now()>a){location.reload();return}setTimeout(d,n);return}(await l.arrayBuffer()).byteLength>0?f():Date.now()>a?location.reload():setTimeout(d,n)}).catch(()=>location.reload())}d()}function P(i){const e=document.createElement("div");return e.className="dev-loading-spinner",e.innerHTML='<svg viewBox="0 0 24 24" width="18" height="18"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-dasharray="42" stroke-dashoffset="14"/></svg>',i.appendChild(e),e}function B(){window.parent.postMessage({source:"webgen-template",type:"saved"},y)}function w(i,e){return fetch(`${y}/api/content`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:i,value:e})}).then(t=>(t.ok&&B(),t)).catch(()=>{})}function I(){const i=document.createElement("style");i.textContent=`
  ...
  `,document.head.appendChild(i),document.querySelectorAll(".dev-column-ratio-handle").forEach(e=>{const t=document.getElementById(e.dataset.ratioTarget||"");if(!t)return;const o=t.children[0],n=t.children[1];if(!o||!n)return;let a=Number(e.dataset.ratioCurrent)||59;const s=document.createElement("button");s.type="button",s.className="dev-ratio-grip",s.innerHTML=C.widthToggle,s.title="Drag to resize columns",s.addEventListener("click",l=>l.preventDefault()),e.appendChild(s);function f(){const l=e.getBoundingClientRect(),r=o.getBoundingClientRect(),g=n.getBoundingClientRect(),u=(r.right+g.left)/2,c=(r.top+r.bottom)/2;s.style.left=`${u-l.left}px`,s.style.top=`${c-l.top}px`}f(),window.addEventListener("resize",f);let d=!1;s.addEventListener("pointerdown",l=>{d=!0,s.classList.add("dragging");try{s.setPointerCapture(l.pointerId)}catch{}}),s.addEventListener("pointermove",l=>{if(!d)return;const r=t.getBoundingClientRect(),g=e.getBoundingClientRect(),u=parseFloat(getComputedStyle(t).columnGap||"0")||0,c=r.width-u,p=l.clientX-r.left,v=Math.round((p-u/2)/c*100),h=$(v,25,75);h!==a&&(a=h,t.style.gridTemplateColumns=`minmax(320px, ${a}fr) minmax(300px, ${100-a}fr)`),s.style.left=`${l.clientX-g.left}px`}),s.addEventListener("pointerup",()=>{d&&(d=!1,s.classList.remove("dragging"),f(),w(e.dataset.ratioKey,a))})})}function Z(){const i=document.createElement("style");i.textContent=`
  ...
  `,document.head.appendChild(i),document.querySelectorAll(".dev-variant-cycle").forEach(e=>{const t=(e.dataset.cycleOptions||"").split(",").filter(Boolean),o=(e.dataset.cycleLabel||"").split(",").filter(Boolean);if(!t.length)return;let n=e.dataset.cycleCurrent||t[0];const a=e.dataset.cycleIcon||"cycle",s=document.createElement("button");s.type="button",s.className="dev-cycle-btn",e.dataset.cycleTitle&&(s.title=e.dataset.cycleTitle);function f(){const d=Math.max(0,t.indexOf(n)),l=o[d];s.innerHTML=l?`${C[a]}<span>${l}</span>`:C[a]}f(),s.addEventListener("click",d=>{if(d.preventDefault(),d.stopPropagation(),s.disabled)return;const l=t.indexOf(n);n=t[(l+1)%t.length],f(),s.disabled=!0;const r=e.dataset.cycleKey;w(r,n).then(()=>x(g=>g.includes(`data-cycle-key="${r}"`)&&g.includes(`data-cycle-current="${n}"`))).catch(()=>{s.disabled=!1})}),e.appendChild(s)})}function _(){const i=document.createElement("style");i.textContent=`
  ...
  `,document.head.appendChild(i),document.querySelectorAll(".dev-gallery-cycle").forEach(e=>{const t=(e.dataset.cycleIds||"").split(",").filter(Boolean);if(t.length<2)return;let o=Number(e.dataset.cycleCurrentIndex);(!Number.isFinite(o)||o<0)&&(o=0);const n=e.dataset.cycleWorkKey,a=document.createElement("button");a.type="button",a.className="dev-gallery-cycle-btn",a.title="Previous photo",a.setAttribute("aria-label","Previous photo"),a.innerHTML=C.chevronLeft;const s=document.createElement("button");s.type="button",s.className="dev-gallery-cycle-btn",s.title="Next photo",s.setAttribute("aria-label","Next photo"),s.innerHTML=C.chevronRight;function f(d){o=(o+d+t.length)%t.length;const l=t[o];a.disabled=!0,s.disabled=!0,w(n,l).then(()=>x(r=>r.includes(`data-cycle-work-key="${n}"`)&&r.includes(`data-cycle-current-index="${o}"`))).catch(()=>{a.disabled=!1,s.disabled=!1})}a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),a.disabled||f(-1)}),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),s.disabled||f(1)}),e.append(a,s)})}function Q(){const i=document.createElement("style");i.textContent=`
    .dev-height-handle {
      opacity: 0; pointer-events: none; transition: opacity .12s ease;
  ...
  `,document.head.appendChild(i),document.querySelectorAll(".dev-height-handle").forEach(e=>{let t;try{t=JSON.parse(e.dataset.handleStops||"[]")}catch{return}if(!t.length)return;let o;if(e.dataset.handleNumeric!==void 0){const r=Number(e.dataset.handleCurrent);o=t.reduce((g,u,c)=>Math.abs(u.save-r)<Math.abs(t[g].save-r)?c:g,0)}else o=t.findIndex(r=>r.name===e.dataset.handleCurrent);o<0&&(o=0);const n=document.createElement("button");n.type="button",n.className="dev-height-grip",n.innerHTML=C.updown,n.title="Drag to resize",n.addEventListener("click",r=>r.preventDefault());function a(r){t[r].effects.forEach(({target:g,prop:u,value:c})=>{const p=document.getElementById(g);p&&(u.startsWith("--")?p.style.setProperty(u,c):p.style[u]=c)})}a(o);let s=!1,f=0,d=0;const l=70;n.addEventListener("pointerdown",r=>{s=!0,e.classList.add("dragging"),f=r.clientY,d=o;try{n.setPointerCapture(r.pointerId)}catch{}}),n.addEventListener("pointermove",r=>{if(!s)return;const g=Math.round((r.clientY-f)/l),u=Math.min(t.length-1,Math.max(0,d+g));u!==o&&(o=u,a(o))}),n.addEventListener("pointerup",()=>{s&&(s=!1,e.classList.remove("dragging"),w(e.dataset.handleKey,t[o].save))}),e.append(n)})}function ee(){const i=document.createElement("style");i.textContent=`
  ...
  `,document.head.appendChild(e),i.querySelectorAll(".services-card").forEach(n=>{const a=n.dataset.serviceId,s=document.createElement("button");s.type="button",s.className="services-card-remove",s.textContent="×",s.title="Remove card",s.addEventListener("click",async f=>{if(f.preventDefault(),f.stopPropagation(),s.disabled=!0,P(n),!(await fetch(`${y}/api/home-services?id=${encodeURIComponent(a)}`,{method:"DELETE"})).ok){s.disabled=!1;return}x(l=>!l.includes(`data-service-id="${a}"`))}),n.appendChild(s)}),i.querySelectorAll(".services-row").forEach(n=>{if(n.children.length>=4)return;const a=n.dataset.rowIndex,s=document.createElement("button");s.type="button",s.className="services-row-add",s.textContent="+",s.title="Add a card to this row",s.addEventListener("click",async f=>{f.preventDefault(),f.stopPropagation(),s.disabled=!0;const d=await fetch(`${y}/api/home-services?row=${encodeURIComponent(a)}`,{method:"POST"});if(!d.ok){s.disabled=!1;return}const l=await d.json();x(r=>r.includes(`data-service-id="${l.id}"`))}),n.appendChild(s)});const t=i.querySelectorAll(".services-row"),o=t[t.length-1];if(o){const n=document.createElement("button");n.type="button",n.className="services-row-add-below",n.textContent="+",n.title="Add a new row of service cards",n.addEventListener("click",async a=>{a.preventDefault(),a.stopPropagation(),n.disabled=!0;const s=await fetch(`${y}/api/home-services`,{method:"POST"});if(!s.ok){n.disabled=!1;return}const f=await s.json();x(d=>d.includes(`data-service-id="${f.id}"`))}),o.appendChild(n)}}function oe(){const i=document.querySelector("[data-faq-list]");if(!i)return;const e=document.createElement("style");e.textContent=`
    .faq-item-remove {
  ...
  `,document.head.appendChild(e);async function t(d){(await fetch(`${y}/api/faq?index=${encodeURIComponent(d)}`,{method:"DELETE"})).ok&&x(r=>(r.match(/data-faq-item="\d+"/g)||[]).length<a.length)}async function o(d){(await fetch(`${y}/api/faq?after=${encodeURIComponent(d)}`,{method:"POST"})).ok&&x(r=>(r.match(/data-faq-item="\d+"/g)||[]).length>a.length)}async function n(d,l){(await fetch(`${y}/api/faq`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({from:d,to:l})})).ok&&x(()=>!0)}const a=Array.from(i.querySelectorAll("[data-faq-item]"));let s=null;function f(){a.forEach(d=>{d.classList.remove("faq-drop-target"),d.querySelector(":scope > .faq-drop-line")?.remove()})}a.forEach((d,l)=>{d.style.position=d.style.position||"relative";const r=document.createElement("button");r.type="button",r.className="faq-item-remove",r.textContent="×",r.title="Remove question",r.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),r.disabled=!0,t(l)}),d.appendChild(r);const g=document.createElement("div");g.className="faq-item-add";const u=document.createElement("button");u.type="button",u.textContent="+",u.title="Insert a question here",u.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),u.disabled=!0,o(l)}),g.appendChild(u),d.after(g);const c=document.createElement("button");c.type="button",c.className="faq-item-grip",c.title="Drag to reorder",c.innerHTML='<svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><circle cx="9" cy="6" r="1.6"/><circle cx="15" cy="6" r="1.6"/><circle cx="9" cy="12" r="1.6"/><circle cx="15" cy="12" r="1.6"/><circle cx="9" cy="18" r="1.6"/><circle cx="15" cy="18" r="1.6"/></svg>',c.draggable=!0,c.addEventListener("click",p=>p.preventDefault()),c.addEventListener("dragstart",p=>{s=l,p.dataTransfer.setData("text/plain",String(l)),p.dataTransfer.effectAllowed="move",p.dataTransfer.setDragImage(d,12,12),d.classList.add("faq-dragging")}),c.addEventListener("dragend",()=>{s=null,d.classList.remove("faq-dragging"),f()}),d.appendChild(c),d.addEventListener("dragover",p=>{if(s===null||s===l)return;p.preventDefault(),p.dataTransfer.dropEffect="move";const v=d.getBoundingClientRect(),h=p.clientY<v.top+v.height/2;f(),d.classList.add("faq-drop-target");const m=document.createElement("div");m.className="faq-drop-line",h?d.prepend(m):d.append(m)}),d.addEventListener("dragleave",p=>{d.contains(p.relatedTarget)||(d.classList.remove("faq-drop-target"),d.querySelector(":scope > .faq-drop-line")?.remove())}),d.addEventListener("drop",p=>{p.preventDefault();const v=Number(p.dataTransfer.getData("text/plain"));if(f(),Number.isNaN(v)||v===l)return;const h=d.getBoundingClientRect(),b=p.clientY<h.top+h.height/2?l:l+1,E=b>v?b-1:b;E!==v&&n(v,E)})})}function ae(){const i=document.createElement("style");i.textContent=`
  ...
  `,document.head.appendChild(i),document.querySelectorAll(".dev-logo-picker").forEach(e=>{const t=(e.dataset.logoOptions||"").split(",").filter(Boolean);let o=(e.dataset.logoCurrent||"").split(",").filter(r=>r&&t.includes(r));const n=document.createElement("button");n.type="button",n.className="dev-logo-picker-toggle",n.textContent="Choose logos";const a=document.createElement("div");a.className="dev-logo-picker-panel";function s(){const r=o.join(",");return e.dataset.logoCurrent=r,w(e.dataset.logoKey,r).then(()=>x(g=>g.includes(`data-logo-key="${e.dataset.logoKey}"`)&&g.includes(`data-logo-current="${r}"`)))}function f(){if(a.innerHTML="",!o.length){const g=document.createElement("div");g.className="dev-logo-picker-empty",g.textContent="No logos selected — showing placeholders.",a.appendChild(g)}o.forEach(g=>{const u=document.createElement("label");u.className="dev-logo-picker-row",u.draggable=!0;const c=document.createElement("span");c.className="dev-logo-picker-grip",c.innerHTML="⋮⋮",c.title="Drag to reorder";const p=document.createElement("input");p.type="checkbox",p.checked=!0,p.addEventListener("click",h=>h.stopPropagation()),p.addEventListener("change",()=>{o=o.filter(h=>h!==g),f(),s()});const v=document.createElement("span");v.textContent=g,u.append(c,p,v),a.appendChild(u),u.addEventListener("dragstart",h=>{h.dataTransfer.setData("text/plain",g),h.dataTransfer.effectAllowed="move",u.classList.add("dragging")}),u.addEventListener("dragend",()=>{u.classList.remove("dragging"),a.querySelectorAll(".drop-target").forEach(h=>h.classList.remove("drop-target"))}),u.addEventListener("dragover",h=>{o.includes(g)&&(h.preventDefault(),h.dataTransfer.dropEffect="move",u.classList.add("drop-target"))}),u.addEventListener("dragleave",()=>u.classList.remove("drop-target")),u.addEventListener("drop",h=>{h.preventDefault(),u.classList.remove("drop-target");const m=h.dataTransfer.getData("text/plain");!m||m===g||!o.includes(m)||(o=o.filter(b=>b!==m),o.splice(o.indexOf(g),0,m),f(),s())})});const r=t.filter(g=>!o.includes(g));if(o.length&&r.length){const g=document.createElement("div");g.className="dev-logo-picker-divider",a.appendChild(g)}if(r.forEach(g=>{const u=document.createElement("label");u.className="dev-logo-picker-row";const c=document.createElement("input");c.type="checkbox",c.checked=!1,c.addEventListener("change",()=>{o=[...o,g],f(),s()});const p=document.createElement("span");p.textContent=g,u.append(c,p),a.appendChild(u)}),r.length||o.length){const g=document.createElement("div");g.className="dev-logo-picker-divider",a.appendChild(g)}a.append(l,d)}const d=document.createElement("input");d.type="file",d.accept="image/png,image/jpeg,image/webp,image/svg+xml",d.style.display="none";const l=document.createElement("button");l.type="button",l.className="dev-logo-picker-add",l.textContent="+ Add custom logo…",l.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),d.click()}),d.addEventListener("change",async()=>{const r=d.files&&d.files[0];if(d.value="",!!r){l.disabled=!0,l.textContent="Uploading…";try{const g=new FormData;g.append("file",r);const u=await fetch(`${y}/api/credentials-logo`,{method:"POST",body:g});if(!u.ok)throw new Error("upload failed");const c=await u.json();o=[...o,c.filename],e.dataset.logoCurrent=o.join(","),await w(e.dataset.logoKey,o.join(",")),x(p=>p.includes(c.filename))}catch{l.disabled=!1,l.textContent="+ Add custom logo…"}}}),n.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),e.classList.toggle("open")}),document.addEventListener("click",r=>{e.contains(r.target)||e.classList.remove("open")}),f(),e.append(n,a)})}function ie(){const i=document.createElement("style");i.textContent=`
  ...
  `,document.head.appendChild(i),document.querySelectorAll(".dev-logo-size-control").forEach(e=>{const t=document.getElementById(e.dataset.sizeTarget||"");if(!t)return;const o=document.createElement("span");o.textContent="Logo size";const n=document.createElement("input");n.type="range",n.min="60",n.max="160",n.step="4",n.value=e.dataset.sizeValue||"104",n.addEventListener("input",()=>{t.style.setProperty("--logo-size",`${n.value}px`),w(e.dataset.sizeKey,Number(n.value))}),e.append(o,n)})}function re(){const i=document.getElementById("photo-grid");if(!i)return;const e=document.createElement("style");e.textContent=`
    .dev-gallery-add {
